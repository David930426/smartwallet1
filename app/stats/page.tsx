...
export default function ReportScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-700 p-4 pb-24 font-sans">
          ...
          {cityExpenses.map((item, index) => (
            <div key={index} className="flex-1 flex flex-col items-center group relative cursor-pointer">
              ...
              <div className="w-full h-full flex items-end justify-center rounded-t-lg bg-gray-100 overflow-hidden relative">
                 <div
                    className="w-full bg-gradient-to-t from-gray-700 to-gray-500 rounded-t-lg transition-all duration-700 ease-out group-hover:from-emerald-500 group-hover:to-teal-400"
                    style={{
        ...
        <div className="flex items-end gap-3 h-48 pb-2">
          {cityComparison.map((city, index) => (
            <div key={index} className="flex-1 flex flex-col items-center group relative">
              ...
              <div
                className="w-full bg-gradient-to-t from-gray-700 to-gray-500 rounded-t-md transition-all duration-500 hover:from-blue-600 hover:to-cyan-400 relative shadow-sm"
                style={{
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 flex flex-col justify-between">
          <div className="flex items-start justify-between">
            <div>
                ...
                <p className="text-white font-bold text-lg tracking-wide truncate max-w-[100px]">
